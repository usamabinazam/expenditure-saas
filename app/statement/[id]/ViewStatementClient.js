...
<html>
  ...
  // ============================================================
  // 2 PRINT HANDLERS - independent customization
  // ============================================================

  // HANDLER 1: Print - 1 Page Fit
  const handlePrintFit = () => {
    const printWindow = window.open('', '_blank');
    printWindow.document.write(buildHTML('fit'));
    printWindow.document.close();
    setTimeout(() => printWindow.print(), 500);
  };

  // HANDLER 2: Print - Multi-Page Normal
  const handlePrintNormal = () => {
    const printWindow = window.open('', '_blank');
    printWindow.document.write(buildHTML('normal'));
    printWindow.document.close();
    setTimeout(() => printWindow.print(), 500);
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-6xl mx-auto px-4 py-6">
        {/* HEADER - title + 2 print buttons + back */}
        <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
          ...
          <div className="flex gap-2 flex-wrap">
            ...
            <button
              ...
              className="px-5 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-bold shadow-md"
            >
              📑 Print - Multi-Page
            </button>
            <button
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4 text-sm text-blue-800">
          💡 <strong>Tip:</strong> Print dialog mein <strong>"Save as PDF"</strong> destination select karke 
          clean PDF bhi bana sakte hain. {totalRows} heads dikhaye ja rahe hain (khaali heads auto-hide).
        </div>
        ...
        {/* ============================================================
            PDF Content - this is what gets cloned for print
            ============================================================ */}
        <div className="bg-white rounded-lg shadow p-6 overflow-x-auto">
          <div id="pdfContent" className="pdf-content">
            
            {/* TITLE 1 - Full width stretched */}
